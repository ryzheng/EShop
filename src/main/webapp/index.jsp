...
<%@ page import="com.eshop.entity.Customer" %>
...
<!-- 顶部开始 -->
<div class="container">
    <div class="logo"><a href="index">E-Shop</a></div>
    <div class="left_open">
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <a href="javascript:;"><%=customer.getCname() %></a>
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
...
<!-- 底部开始 -->
<div class="footer">
    <div class="copyright">Copyright © 2019 E Shop All Rights Reserved</div>
</div>
<!-- 底部结束 -->
</body>
</html>
